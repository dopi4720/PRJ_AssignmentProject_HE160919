...
public abstract class DBContext<T> {
    ...
    public DBContext()
    {
        try {
            String user = "sa";
            String pass = "dopi4720";
            String url = "jdbc:sqlserver://localhost\\DESKTOP-3PS4NQ2:1433;databaseName=PRJ301_FALL2022_Assignment;encrypt=true;trustServerCertificate=true;";
